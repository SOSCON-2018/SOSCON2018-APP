...
public class ScheduleMainVenueView extends BaseFragment {
    ...
    protected void PreGetData() {
        handlerID=0x77;
        schedulelist = mview.findViewById(R.id.main_venue_schedule_recycler);
        if(firstLoad) {
...
//                mDialog.show();
    ...
    protected void InitView() {
        if(firstLoad) {
            mTask = new Getschedule("https://soscon.top/schedule/getB", handlerID, mHandler);
            mTask.GetSchedule();
            firstLoad=false;
        }
    }
    ...
    public int GetLayoutId() {
        return R.layout.main_venue_schedule;
    }
