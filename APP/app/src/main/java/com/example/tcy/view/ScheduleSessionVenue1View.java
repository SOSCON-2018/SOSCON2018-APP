...
public class ScheduleSessionVenue1View extends BaseFragment {
    ...
    protected void PreGetData() {
        handlerID=0x55;
        schedulelist = mview.findViewById(R.id.session_venue_1_schedule_recycler);
        if(firstLoad) {
...
//                mDialog.show();
    ...
    protected void InitView() {
        if(firstLoad) {
            mTask = new Getschedule("https://soscon.top/schedule/getD", handlerID, mHandler);
            mTask.GetSchedule();
            firstLoad = false;
        }
    }
    ...
    public int GetLayoutId() {
        return R.layout.session_venue_1_schedule;
    }
}
